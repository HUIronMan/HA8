...
\subsection*{c)}
Alle Komponenten einer Ebene können theoretisch in beliebiger Reihenfolge integriert werden woraus sich verschiedene Varianten ergeben. in diesem Beispiel E, F und D. Eine optimale Variante bindet D als letztes ein um die Anzahl der zu verwendenden Platzhalter zu einem Zeitpunkt so gering wie möglich zu halten. Also in diesem den Paltzhalter von A so simpel wie möglich zu gestalten und so spät wie möglich zu verwenden.
